...
class FleetConfigSettings(models.TransientModel):
    ...
    inactivity_period_duration = fields.Char(string='Inactivity Period Duration (min)', help='Enter a time interval which will be a threshold for the inactivity of a vehicle (in minutes).')
